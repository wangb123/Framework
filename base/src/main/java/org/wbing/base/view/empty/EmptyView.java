...
public class EmptyView extends LinearLayout implements IEmptyLayout {
     ...
     * 空view的文案
     */
    private final String mEmptyText = getResources().getString(R.string.empty_otherall);

    /**
     * 错误view的文案
     */
    private final String mErrorText = getResources().getString(R.string.error_default);
    ...
    private void init() {
        ...
        mEmptyTextView = mEmptyView.findViewById(R.id.text);
        mEmptySubHeadView = mEmptyView.findViewById(R.id.sub_head);
        mEmptyImageView = mEmptyView.findViewById(R.id.icon);
        mEmptyBtn = mEmptyView.findViewById(R.id.btn);
    }
    ...
    public void showErrorView(int errorCode, String errorMessage) {
        ...
        if (TextUtils.isEmpty(errorMessage)) {
            ...
            mEmptyTextView.setText(errorMessage);
        }
