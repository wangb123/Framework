...
import org.wbing.base.view.empty.IEmptyLayout;
 ...
 * @see RefreshLayout
 */
public abstract class EmptyRefreshLayout extends RefreshLayout implements IEmptyLayout {
     ...
     * 空View
     */
    protected IEmptyLayout mEmptyView;
...
//    private OnEmptyOrErrorListener emptyOrErrorListener;
    ...
    public void showErrorView(int errorCode, String errorMessage) {
        mEmptyView.showErrorView(errorCode, errorMessage);
        ...
        mRefreshView = mEmptyView.getView();
...
//     * 显示错误view
//     */
//    public void showErrorView(int SString hint) {
//        mEmptyView.showErrorView(0,hint);
//    }
//
//    /**
//     * 显示错误view
...
//        showErrorView(0, getResources().getString(R.string.error_default));
//    }
////
////    @Override
